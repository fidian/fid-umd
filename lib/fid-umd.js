 ...
 * @license MIT
 */
// fid-umd {"name":"FidUmd","jslint":1,"depends":[{"name":"Config","nodejs":"./config","commonjsmod":"Config"},{"name":"Commonjs","nodejs":"./modules/commonjs","commonjsmod":"Commonjs"},{"name":"Modulejs","nodejs":"./modules/modulejs","commonjsmod":"Modulejs"},{"name":"Nodejs","nodejs":"./modules/nodejs","commonjsmod":"Nodejs"},{"name":"Amd","nodejs":"./modules/amd","commonjsmod":"Amd"},{"name":"Root","nodejs":"./modules/root","commonjsmod":"Root"},{"name":"Yui","nodejs":"./modules/yui","commonjsmod":"Yui"}]}
/*global define, modulejs, YUI*/
(function (name, root, factory) {
    "use strict";
    function isObject(x) { return typeof x === "object"; }
    if (isObject(module) && isObject(module.exports)) {
        module.exports = factory(require("./config"), require("./modules/commonjs"), require("./modules/modulejs"), require("./modules/nodejs"), require("./modules/amd"), require("./modules/root"), require("./modules/yui"));
    } else if (isObject(exports)) {
        exports[name] = factory(require("Config").Config, require("Commonjs").Commonjs, require("Modulejs").Modulejs, require("Nodejs").Nodejs, require("Amd").Amd, require("Root").Root, require("Yui").Yui);
    } else if (isObject(define) && define.amd) {
        define(name, ["Config", "Commonjs", "Modulejs", "Nodejs", "Amd", "Root", "Yui"], factory);
    } else if (isObject(modulejs)) {
        modulejs.define(name, ["Config", "Commonjs", "Modulejs", "Nodejs", "Amd", "Root", "Yui"], factory);
    } else if (isObject(YUI)) {
        YUI.add(name, function (Y) { Y[name] = factory(Y.Config, Y.Commonjs, Y.Modulejs, Y.Nodejs, Y.Amd, Y.Root, Y.Yui); }, "", { requires: ["Config", "Commonjs", "Modulejs", "Nodejs", "Amd", "Root", "Yui"] });
    } else {
        root[name] = factory(root.Config, root.Commonjs, root.Modulejs, root.Nodejs, root.Amd, root.Root, root.Yui);
    }
}("FidUmd", this, function (Config, Commonjs, Modulejs, Nodejs, Amd, Root, Yui) {
    "use strict";
    // fid-umd end
    ...
    FidUmd.prototype.createPostamble = function () {
        var name;  // Necessary to hide the markers from our own library
        name = '// fid-umd ';
        return '    ' + name + 'post\n}));\n' + name + 'post-end\n';
    };
