 ...
 * @license MIT
 */
// fid-umd {"depends":[{"name":"Config","commonjs":"./config"},{"name":"Commonjs","commonjs":"./modules/commonjs"},{"name":"Modulejs","commonjs":"./modules/modulejs"},{"name":"Nodejs","commonjs":"./modules/nodejs"},{"name":"Amd","commonjs":"./modules/amd"},{"name":"Root","commonjs":"./modules/root"},{"name":"Yui","commonjs":"./modules/yui"}],"jslint":1,"name":"FidUmd"}
/*global define, YUI*/
(function (n, r, f) {
    "use strict";
    try { module.exports = f(require("./config"), require("./modules/commonjs"), require("./modules/modulejs"), require("./modules/nodejs"), require("./modules/amd"), require("./modules/root"), require("./modules/yui")); return; } catch (ignore) {}
    try { exports[n] = f(require("./config"), require("./modules/commonjs"), require("./modules/modulejs"), require("./modules/nodejs"), require("./modules/amd"), require("./modules/root"), require("./modules/yui")); return; } catch (ignore) {}
    try { return define.amd && define(n, ["Config", "Commonjs", "Modulejs", "Nodejs", "Amd", "Root", "Yui"], f); } catch (ignore) {}
    try { return YUI.add(n, function (Y) { Y[n] = f(Y.Config, Y.Commonjs, Y.Modulejs, Y.Nodejs, Y.Amd, Y.Root, Y.Yui); }, "", { requires: ["Config", "Commonjs", "Modulejs", "Nodejs", "Amd", "Root", "Yui"] }); } catch (ignore) {}
    try { r[n] = f(r.Config, r.Commonjs, r.Modulejs, r.Nodejs, r.Amd, r.Root, r.Yui); return; } catch (ignore) {}
