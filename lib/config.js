...
Config.prototype.expandDepends = function (input) {
    ...
    /**
     * Copies one value fron the input object to the result if it is defined.
     *
    ...
    /**
     * Set up the default module names.
     *
     * @param {Object} self
     * @param {string} str Name of module
     * @return {Object}
     */
    function makeDefault(self, str) {
        var output;
    ...
    if (typeof input === "string") {
        return makeDefault(this, input);
    }

    if (input.name) {
        result = makeDefault(this, input.name);
    } else {
        result = makeDefault(this, "Unknown");
    }
